...
//                                 <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <Link class="font-medium text-primary-600 hover:underline dark:text-primary-500" to="/terms">Terms and Conditions</Link></label>
//                             </div>
//                         </div>
